...
will be used. This has been calculated in Section \@ref(spot-rates), and the
...
```{r spot-rate-summary, echo=FALSE}
spot_rates_q1 %>%
...
reported in Table \@ref(tab:acf-table), along with a plot of the ACF for the series in Figure \@ref(fig:acf-chart). Each of the series are highly autocorrelated.
