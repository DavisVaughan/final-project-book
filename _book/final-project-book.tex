...
\NormalTok{spot_rates_q1 <-}\StringTok{ }\NormalTok{rates }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(maturity_nm }\OperatorTok{%in%}\StringTok{ }\NormalTok{n)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{plot_rates_vs_predictions <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(.rates, .model, .maturity) \{}
\NormalTok{  .rates }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(maturity }\OperatorTok{==}\StringTok{ }\NormalTok{.maturity) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{Realized =}\NormalTok{ spot_rate) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Predicted =} \KeywordTok{predict}\NormalTok{(.model)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{gather}\NormalTok{(}\StringTok{"Realized/Predicted"}\NormalTok{, }\StringTok{"Spot Rate"}\NormalTok{, Realized, Predicted) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ date, }\DataTypeTok{y =} \StringTok{`}\DataTypeTok{Spot Rate}\StringTok{`}\NormalTok{, }\DataTypeTok{color =} \StringTok{`}\DataTypeTok{Realized/Predicted}\StringTok{`}\NormalTok{)) }\OperatorTok{+}
...
\begin{figure}
\centering
\includegraphics{final-project-book_files/figure-latex/unnamed-chunk-36-1.pdf}
...
\begin{figure}
\centering
\includegraphics{final-project-book_files/figure-latex/unnamed-chunk-39-1.pdf}
...
\begin{figure}
\centering
\includegraphics{final-project-book_files/figure-latex/unnamed-chunk-42-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{extract_rates <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(.rates, .date) \{}
\NormalTok{  .rates }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{as_tbl_time}\NormalTok{(date) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{group_by}\NormalTok{(maturity) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tidy_decomposed_spot_rate <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(.rates, .nested_models, .date) \{}
\NormalTok{  .rates }\OperatorTok{%>%}\StringTok{ }
...
\caption{\label{fig:unnamed-chunk-48}Decomposed Spot Rate for January 2012}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-49}Decomposed Spot Rate for January 1981}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{all_splits <-}\StringTok{ }\NormalTok{spot_rates_q2 }\OperatorTok{%>%}
\StringTok{  }\CommentTok{# Add on the curve factors}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(yield_curve_factors, }\DataTypeTok{by =} \StringTok{"date"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(maturity) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{maturity_nm) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{nest}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\CommentTok{# For each maturity, split the data into subsets of 100 data points}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{data_splits =} \KeywordTok{map}\NormalTok{(data, }\OperatorTok{~}\KeywordTok{rolling_origin}\NormalTok{(.x, }\DataTypeTok{initial =} \DecValTok{100}\NormalTok{, }\DataTypeTok{assess =} \DecValTok{1}\NormalTok{, }\DataTypeTok{cumulative =} \OtherTok{FALSE}\NormalTok{)))}

\NormalTok{all_splits}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{all_splits}\OperatorTok{$}\NormalTok{data_splits[[}\DecValTok{1}\NormalTok{]]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{analysis}\NormalTok{(all_splits}\OperatorTok{$}\NormalTok{data_splits[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{splits[[}\DecValTok{1}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{all_splits <-}\StringTok{ }\NormalTok{all_splits }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \DataTypeTok{model_coef =} \KeywordTok{future_map}\NormalTok{(data_splits, }\OperatorTok{~}\NormalTok{\{ }\CommentTok{# For each maturity...}
      
\NormalTok{      maturity_splits <-}\StringTok{ }\NormalTok{.x}
      
      \KeywordTok{map_dfr}\NormalTok{(maturity_splits}\OperatorTok{$}\NormalTok{splits, }\OperatorTok{~}\StringTok{ }\NormalTok{\{ }\CommentTok{# For each split...}
        
\NormalTok{        split.x <-}\StringTok{ }\NormalTok{.x}
\NormalTok{        date <-}\StringTok{ }\KeywordTok{assessment}\NormalTok{(split.x)}\OperatorTok{$}\NormalTok{date}

        \CommentTok{# Run the model}
\NormalTok{        mod <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(spot_rate }\OperatorTok{~}\StringTok{ }\NormalTok{level }\OperatorTok{+}\StringTok{ }\NormalTok{slope }\OperatorTok{+}\StringTok{ }\NormalTok{curvature, }\DataTypeTok{data =} \KeywordTok{analysis}\NormalTok{(split.x))}

        \CommentTok{# Tidy up}
\NormalTok{        tidy_mod <-}\StringTok{ }\NormalTok{mod }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tidy}\NormalTok{()}
        \KeywordTok{mutate}\NormalTok{(tidy_mod, }\DataTypeTok{date =}\NormalTok{ date) }\OperatorTok{%>%}
\StringTok{          }\KeywordTok{select}\NormalTok{(date, term, estimate)}
\NormalTok{      \})}
\NormalTok{    \})}
\NormalTok{  )}
...
\begin{figure}
\centering
\includegraphics{final-project-book_files/figure-latex/unnamed-chunk-55-1.pdf}
...
\begin{figure}
\centering
\includegraphics{final-project-book_files/figure-latex/unnamed-chunk-56-1.pdf}
...
\begin{figure}
\centering
\includegraphics{final-project-book_files/figure-latex/unnamed-chunk-57-1.pdf}
